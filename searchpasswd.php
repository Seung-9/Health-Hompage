    ...
    * {
    ...
    <body>
        <div class="warp">
            ...
            <div class="container">
              <form action="searchproc_passwd.php" method="post">
              <div class="row">
                        <div class="col-25">
                      ...
                      <div class="row">
                        ...
                        <div class="col-75">
                          <input type="text" name="telno" placeholder="전화번호 입력">
                        </div>
                      </div>
                      <input type="submit" onclick="locaton.href='searchproc_passwd.php';" value="확인">
                </form>
            </div>
        </div>
    </body>
